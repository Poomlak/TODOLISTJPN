...
CREATE TABLE `member_diary` (
  ...
  `member_createdbook` varchar(45) DEFAULT NULL,
  `member_lastupdatedbook` varchar(45) DEFAULT NULL,
  `member_todo` varchar(2555) DEFAULT NULL,
...
INSERT INTO `member_diary` VALUES (5,'test2','admin	test db1211',NULL,NULL,NULL),(6,'admin','jame','2024-10-21 16:25:06','2024-10-21 16:25:06',NULL),(7,'admin','testpoom','2024-10-21 16:27:59','2024-10-21 16:27:59',NULL);
...
-- Dump completed on 2024-10-21 16:31:00
